...
claims
  ...
  channel               text NOT NULL DEFAULT 'portal'  -- portal | whatsapp — decides which authorized-claimant signal validate-claim trusts (below); 'whatsapp' unused until .claude/specs/generic/claims-assistant.md ships
